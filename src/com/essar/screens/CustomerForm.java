...
public class CustomerForm extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        lblCustomerPhoneNumber1 = new javax.swing.JLabel();
        ...
        lblCustomerPhoneNumber1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lblCustomerPhoneNumber1.setText("GSTIN");

        txtGSTNumber.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(lblCustomerPhoneNumber1, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblCustomerPhoneNumber1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtGSTNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void saveCustomerForm(){
        ...
        if(null!= txtGSTNumber.getText() && !("".equals(txtGSTNumber.getText()))){
            customer.setAddress(txtAddress.getText()+"\nGSTIN-"+txtGSTNumber.getText());
        }else{
            customer.setAddress(txtAddress.getText());
        }
        CustomerDAO customerDAO = new CustomerDAO();
    ...
    private javax.swing.JLabel lblCustomerPhoneNumber1;
    ...
    public void actionPerformed(ActionEvent event) {
        try{
            ...
            if (menu == mitDelete) {
                ...
                List<SalesView> salesList = salesDAO.retrieveSalesByQuery("SELECT * FROM sales where customer_id="+id);
                if(salesList.size()>0){
                    JOptionPane.showMessageDialog(this, "You can't delete this customer. There is sales record corresponding to this Customer already.");
                }else{
                    int option =JOptionPane.showConfirmDialog(this, "Are you sure to delete the selected customer details?","Delete Alert!",JOptionPane.YES_NO_OPTION);
