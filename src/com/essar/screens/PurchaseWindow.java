...
public class PurchaseWindow extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        txtItemName.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ...
        tblPurchaseDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Rate", "GST%", "GST Amt", "Qty", "Net Amount", "WholesalePrice", "RetailPrice", "MRP", "", ""
            }
        ) {
                ...
                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlPurchaseLayout.createSequentialGroup()
                        .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtItemName, javax.swing.GroupLayout.PREFERRED_SIZE, 341, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlPurchaseLayout.createSequentialGroup()
                                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlPurchaseLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtRate, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtPurchasePrice, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblMrp, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlPurchaseLayout.setVerticalGroup(
            ...
            .addGroup(pnlPurchaseLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(spnPurchaseItems, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlPurchaseLayout.createSequentialGroup()
                        .addGroup(pnlPurchaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void txtRateKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRateKeyReleased
        ...
        if(evt.getKeyCode()== KeyEvent.VK_ENTER && txtPurchasePrice.getText()!=null){
               txtQuantity.requestFocus();
        }
    ...
    private void txtMrpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMrpKeyReleased
        // TODO add your handling code here:
        if(evt.getKeyCode()== KeyEvent.VK_ENTER && null!=txtMrp.getText()){
               txtQuantity.requestFocus();
        }
    ...
    public void savePurchaseForm(){
        ...
        for(int i=0;i<purchaseDetailsModel.getRowCount();i++){
            ...
            purchaseDetails.setMrp(Double.parseDouble(purchaseDetailsModel.getValueAt(i, 9).toString()));
            purchaseDetails.setItemId(Long.parseLong(purchaseDetailsModel.getValueAt(i, 10).toString()));
