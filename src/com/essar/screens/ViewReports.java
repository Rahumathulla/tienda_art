...
public class ViewReports extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        btnStockStandingReport = new javax.swing.JButton();
        btnGstWisePurchaseReport = new javax.swing.JButton();
        ...
        btnSalesReport.setBounds(40, 20, 230, 50);
        ...
        btnStockReport.setBounds(40, 80, 230, 50);
        ...
        btnPurchaseReport.setBounds(280, 20, 220, 50);
        ...
        btnStockAlertReport.setBounds(280, 80, 220, 50);
        ...
        cmdCancel.setBounds(400, 200, 102, 42);

        btnStockStandingReport.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        btnStockStandingReport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stock.png"))); // NOI18N
        btnStockStandingReport.setMnemonic('t');
        btnStockStandingReport.setText("Stock History Report");
        btnStockStandingReport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnStockStandingReportActionPerformed(evt);
            }
        });
        getContentPane().add(btnStockStandingReport);
        btnStockStandingReport.setBounds(40, 140, 230, 50);

        btnGstWisePurchaseReport.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        btnGstWisePurchaseReport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/income_statement.png"))); // NOI18N
        btnGstWisePurchaseReport.setMnemonic('G');
        btnGstWisePurchaseReport.setText("GST-wise Purchase Report");
        btnGstWisePurchaseReport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGstWisePurchaseReportActionPerformed(evt);
            }
        });
        getContentPane().add(btnGstWisePurchaseReport);
        btnGstWisePurchaseReport.setBounds(280, 140, 220, 50);
    ...
    private void btnStockAlertReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStockAlertReportActionPerformed
        // TODO add your handling code here:
        QueryStrings.stockQuery = "SELECT * from stock where quantity <= reorder_quantity";
    ...
    private void btnStockStandingReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStockStandingReportActionPerformed
        // TODO add your handling code here:
        this.dispose();
    ...
    }//GEN-LAST:event_btnStockStandingReportActionPerformed

    private void btnGstWisePurchaseReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGstWisePurchaseReportActionPerformed
        // TODO add your handling code here:
        this.dispose();
        GstPurchaseReport gstPurchaseReport =  new GstPurchaseReport();
        gstPurchaseReport.setBounds(60, 60, 630, 360);
        gstPurchaseReport.setVisible(true);
    }//GEN-LAST:event_btnGstWisePurchaseReportActionPerformed
    ...
    private javax.swing.JButton btnGstWisePurchaseReport;
    ...
    private javax.swing.JButton btnStockStandingReport;
