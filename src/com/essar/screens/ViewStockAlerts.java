 ...
 * @author rahumathulla
 */
public class ViewStockAlerts extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        panStockAlertView.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                panStockAlertViewKeyPressed(evt);
            }
        });
        ...
        tblStockAlertView.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tblStockAlertViewKeyPressed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(panStockAlertView, javax.swing.GroupLayout.PREFERRED_SIZE, 513, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblStockAlertViewKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblStockAlertViewKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()== KeyEvent.VK_HOME && tblStockAlertView.getRowCount()>0){
    ...
    }//GEN-LAST:event_tblStockAlertViewKeyPressed

    private void panStockAlertViewKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_panStockAlertViewKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            syncDataFromViewToTable();
        }
    }//GEN-LAST:event_panStockAlertViewKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStockAlerts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStockAlerts().setVisible(true);
            }
        });
    }
    ...
    public void initializeForm(){
        ...
        tblStockAlertView.setAutoCreateRowSorter(true);
    ...
    public void renderDataIntoTable(List<Stock> stockList){
        ...
        idColumn1.setPreferredWidth(70);
        idColumn1.setMinWidth(70);
        idColumn1.setMaxWidth(70);
        //idColumn1.
